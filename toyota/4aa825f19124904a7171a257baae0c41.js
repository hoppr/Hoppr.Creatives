! function(t) {
    ...
    var x = function(t) {
        ...
        E = function() {
            ...
            return "http://".concat(t, "www.").concat(t, "w3.").concat(t, "org/2000/svg")
        },
        A = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            return "http://".concat(t, "www.").concat(t, "w3.").concat(t, "org/1999/xlink")
        },
        T = {
            linear: "linear",
            ease: "ease",
    ...
    var ct = function(t) {
        ...
        return function(t, e) {
            ...
            value: function() {
                ...
                "hover" !== l.startEnd ? (Z.animate(a, l, "buildMid"), t.buildTimeouts.push(M((function() {
                    (r && p === l.duration || !r) && (l.delay = 0, l.duration = 0, h(), Z.animate(a, l, "buildMid")), l.delay = d, l.duration = p
                }), 1e3 * (l.delay + l.duration)))) : (t.isHover = !1, c && !u && (l.onAnimationEnd = null), M((function() {
                    l.delay = 0, a.addEventListener("mouseenter", e), a.addEventListener("animationiteration", i), a.addEventListener("mouseleave", n), M((function() {
                        a.removeEventListener("mouseenter", e), a.removeEventListener("animationiteration", i), a.removeEventListener("mouseleave", n), (r && p === l.duration || !r && c && !u) && (l.delay = 0, l.duration = 0, h(), Z.animate(a, l, "buildMid")), l.delay = d, l.duration = p
                    }), 1e3 * l.duration)
                }), 1e3 * l.delay))
            }
        }, {
            ...
            value: function() {
                var t = this.getAnimationEl(),
                    ...
                    n = this;
                n.buildTimeouts.push(M((function() {
                    n.trigger("buildOutStart")
                }), 1e3 * e.delay)), Z.animate(t, e, "buildOut"), n.buildTimeouts.push(M((function() {
            ...
            value: function(t, skipAnimation) {
				...
				window.t9000 = window.t9000 || new Set()
				if(!window.t9000.has(this)) {
					window.t9000.add(this)
				}
                ...
                r && "none" !== r.type ? (this.buildTimeouts.push(M((function() {
                    e.trigger("buildInStart")
                }), 1e3 * r.delay)), "instant" === r.type && r.delay > 0 && (n.style.display = "none", this.buildTimeouts.push(M((function() {
                    n.style.display = ""
                }), 1e3 * (r.delay + t)))), r.onAnimationEnd = function() {
                    o && "none" !== o.type ? e.setBuildMidAnimation() : a && "none" !== a.type && e.setBuildOutAnimation()
                }, Z.animate(n, r, "buildIn", t), this.buildTimeouts.push(M((function() {
    ...
    var bt = function(t) {
        ...
        return function(t, e) {
            ...
            value: function(t) {
                ...
                this.container.style.display = "", this.container.style.zIndex = "1", this.trigger("buildInStart"), t && "none" !== t.type && !this.banner.noAnimation && s > 1 ? (this.addClass(this.container, "buildin"), l = parseFloat(t.duration) || 0, a && (a.style.display = ""), "hide" !== t.crosstype ? Z.animate(i, t, "buildIn") : a && (a.style.zIndex = "2"), M((function() {
                ...
                if (!this.isLastSlide() || u || c || this.banner.loopsPlayed++, o.stopSlide || this.banner.showOnlyOneSlide || !c && u && this.isLastSlide() || (this._buildOutTimeout = M((function() {
                        r.buildOut()
            ...
            key: "buildOut",
            value: function(t) {
                this._buildOutTimeout && U(this._buildOutTimeout);
                ...
                t || (t = this.getNextSlide()), t === this && r && (U(r), i.removeClass(i.container, "buildout"), i.trigger("buildOutEnd")), t.play(m(n))
            }
        }, {
            key: "getBuildOutTime",
            value: function() {
    ...
    var Dt = function(t) {
        function e(t) {
            ...
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), (n = It(this, Lt(e).call(this))).retina = t, n
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
    ...
    var Nt = function(t) {
        function e(t) {
            ...
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), (n = Ut(this, Ft(e).call(this))).retina = t, n
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
    ...
    var Xt = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), Wt(this, qt(e).apply(this, arguments))
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function(t) {
                var n = t.properties;
                return this.properties = n, this.createMainContainers("element", "text"), this.innerDisplayContainer = this.createElement("div", "innerDisplayContainer", !0, this.displayContainer, null), this.innerDisplayContainer.dir = n.textDirection || "ltr", this.initCommonProperties(), n.config ? this.initRichText() : this.initSimpleText(), this.reset(), Gt(qt(e.prototype), "init", this).call(this, t)
            }
        }, {
            ...
            value: function() {
                var t;
                Gt(qt(e.prototype), "reset", this).call(this, this), t = this.properties.config ? this.container.getElementsByClassName("word") : this.container.getElementsByClassName("text-content")[0].getElementsByTagName("span"), Z.clearWordsTimeout(this.container, t);
    ...
    var Zt = function(t) {
        ...
        return function(t, e) {
            ...
            key: "init",
            value: function(t) {
                if (this.properties = t.properties, this.clipart = this.properties.svgObject, this.createMainContainers("element", "bs-clipart"), this.transformContainer = this.createElement("div", "transform-container"), this.displayContainer.parentNode.appendChild(this.transformContainer), this.transformContainer.appendChild(this.displayContainer), this.displayContainer.setAttribute("id", "ce-".concat((Math.random() + (new Date).getTime()).toString(36).replace(".", ""))), this.clipart.attributes && this.clipart.attributes["data-height"]) {
                    var e = parseFloat(this.clipart.attributes["data-height"]);
                    for (var n in this.clipart.children) this.clipart.children[n].attributes && this.clipart.children[n].attributes.transform && 0 !== e && (this.clipart.children[n].attributes.transform = "scale(".concat((this.properties.height / e).toFixed(3), ")"))
                }
                ...
                var i = this.getFlipString(this.properties.flip);
                if (this.transform("translateZ(0) rotate(".concat(this.properties.rotation, "deg) ").concat(i), this.transformContainer), this.reset(), this.slide.banner.statsPresent) {
                    var r = this.displayContainer.querySelector(".actionMask") ? this.displayContainer.querySelector(".actionMask") : this.displayContainer;
                    this.slide.banner.stats.trackEvent(r, this)
                }
                return this.applyActions(this.createActionProperties(), this.displayContainer.querySelector(".actionMask")), ct.prototype.init.call(this, t)
            }
        }, {
            key: "makeClipartItem",
            value: function(t, e) {
                var n, i, r = this,
                    ...
                    a = document.createElementNS(E(), t.type);
                if ("svg" === t.type)
                    for (n in o) a.setAttribute(n, o[n]);
                for (n in ["ellipse", "image", "line", "path", "polygon", "polyline", "rect", "use", "circle"].includes(t.type) && a.setAttribute("fill", this.properties.fillColor), t.attributes)
                    if ("fill" == n && "url" == t.attributes[n].slice(0, 3)) {
                        var s = t.attributes[n].slice(5).slice(0, -1);
                        a.setAttribute(n, "url(#".concat(s).concat(this.displayContainer.getAttribute("id"), ")"))
                    } else i = "className" === n ? "class" : n, a.setAttribute(i, t.attributes[n]);
    ...
    var oe = function(t) {
            function e() {
                return function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, e), ne(this, ie(e).apply(this, arguments))
            }
            var n, i, s;
            return function(t, e) {
                if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
        ...
        se = function(t, e) {
            ...
            return function(t) {
                ...
                if (!P[t]) {
                    for (var n, i, r = "@keyframes ".concat(t, " {"), o = "@-webkit-keyframes ".concat(t, " {"), a = 0; n = e[a]; a++) r += i = _(n.percent, n.props), o += i;
                    var s = (r += "}") + (o += "}"),
                        l = document.createElement("style");
                    l.type = "text/css", l.styleSheet ? l.styleSheet.cssText = s : l.innerHTML = s, document.getElementsByTagName("head")[0].appendChild(l), P[t] = !0
                }
            }(s, [{
                percent: n ? 0 : 100,
                props: {
    ...
    window.BS_eaUtils = r, window.BS_eaUtils, window.BS_eff = Z, window.BS_eff, window.BS_EventDispatcher = et, window.BS_EventDispatcher, window.BS_BaseDisplay = ct, window.BS_BaseDisplay, window.BS_BannerDisplay = Ct, window.BS_BannerDisplay, window.BS_SlideDisplay = bt, window.BS_SlideDisplay, window.BS_EmbedCanvas = Tt, window.BS_EmbedCanvas, window.BS_ImageDisplay = Dt, window.BS_ImageDisplay, window.BS_ShapeDisplay = Nt, window.BS_ShapeDisplay, window.BS_TextDisplay = Xt, window.BS_TextDisplay, window.BS_ClipartDisplay = Zt, window.BS_ClipartDisplay, window.BS_ButtonDisplay = oe, window.BS_ButtonDisplay, window.BS_scale = se, window.BS_scale, window.BS_init = le, window.BS_init, window.BS_ShowWatermark = function() {
