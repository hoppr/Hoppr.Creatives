! function(t) {
        ...
        switch ("lgrad" !== i && "rgrad" !== i || (t.gradColors && t.gradColors.length ? t.gradColors.length < 2 && t.gradColors.length > 0 && (r = t.gradColors[0].c, i = "solid") : (i = "solid", r = "#fff")), "true" === String(t.useBorder) && (e.border = "1px solid ".concat(t.borderColor)), e["background-image"] = "", i) {
            ...
            case "lgrad":
                ...
                if ("rgrad" === t.type) {
                    ...
                    h = "".concat(y, ", circle cover")
                } else t.backgroundRotation && (h = "".concat(t.backgroundRotation, "deg"));
                if (c && c.length > 0)(t = e["background-image"] = []).push("-webkit-".concat(f, "-gradient(").concat(h, ",  ").concat(p, ")")), t.push("-moz-".concat(f, "-gradient(").concat(h, ",  ").concat(p, ")")), t.push("-o-".concat(f, "-gradient(").concat(h, ",  ").concat(p, ")")), t.push("-ms-".concat(f, "-gradient(").concat(h, ",  ").concat(p, ")"));
    ...
    var Z = function() {
                ...
                if ("none" !== o.type) {
                    ...
                    if (!d || p || null === u) {
                        if ("rotate" === o.type || "flip" === o.type) {
                            var f = "".concat(Math.round(.7 * r.offsetWidth + .7 * r.offsetHeight), "px");
                            r.style.perspective = f, r.style.webkitPerspective = f
                        }
                        if (r && p) {
                            u = p(o, n, r, a);
                            var h = this.getAnimationDuration(o, n),
                                y = this.getAnimationIterationCount(o, n),
                                b = "".concat(u, " ").concat(h, "s ").concat(function(t) {
        ...
        }], (n = null) && K(e.prototype, n), i && K(e, i), t
    }();
    ...
    var ct = function(t) {
        ...
        return function(t, e) {
            ...
            value: function() {
                var t, e;
                for (Z.clearAll(this.container), t = 0; e = this.buildTimeouts[t]; t++) M(e);
            ...
            value: function() {
                ...
                function e() {
                    t.isHover = !0, Z.animate(a, l, "buildMid")
                }
                ...
                if (!t.properties.showOnAllSlides) {
                    var h = t.slide.displayData.properties.duration,
                ...
                "hover" !== l.startEnd ? (Z.animate(a, l, "buildMid"), t.buildTimeouts.push(U((function() {
                    (r && p === l.duration || !r) && (l.delay = 0, l.duration = 0, f(), Z.animate(a, l, "buildMid")), l.delay = d, l.duration = p
                    ...
                    l.delay = 0, a.addEventListener("mouseenter", e), a.addEventListener("animationiteration", i), a.addEventListener("mouseleave", n), U((function() {
                        a.removeEventListener("mouseenter", e), a.removeEventListener("animationiteration", i), a.removeEventListener("mouseleave", n), (r && p === l.duration || !r && c && !u) && (l.delay = 0, l.duration = 0, f(), Z.animate(a, l, "buildMid")), l.delay = d, l.duration = p
                    }), 1e3 * l.duration)
                }), 1e3 * l.delay))
            }
        }, {
            ...
            value: function() {
                ...
                }), 1e3 * e.delay)), Z.animate(t, e, "buildOut"), n.buildTimeouts.push(U((function() {
            ...
            value: function(t, skipAnimation) {
                ...
                }, Z.animate(n, r, "buildIn", t), this.buildTimeouts.push(U((function() {
    ...
    var bt = function(t) {
        function e() {
            ...
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), (t = pt(this, ht(e).call(this))).banner = null, t.rendered = !1, t._buildOutTimeout = null, t.container = null, t.elements = [], t.LOOP_COUNT_FOREVER = 0, t
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function(t, n) {
                ...
                return this.banner.statsPresent && this.banner.stats.trackEvent(this.container, this), ft(ht(e.prototype), "init", this).call(this, t)
            }
        }, {
            key: "parseTransition",
            value: function(t) {
            ...
            value: function(t) {
                ...
                if (e = ["ImageDisplay", "ShapeDisplay", "EmbedDisplay"].includes(l) ? new c(this.banner.properties.retina) : "audio" === t.layerType && (d || p) ? null : new c) {
                    e.slide = this;
                    var f = e.init(t).getContainer();
                    this.displayContainer.appendChild(f), e.render(), this.isOverflowSlide && (e.container.style.zIndex = 10, e.container.style.webkitTransform = "translate3d(0, 0, 0)")
                }
                return e
            }
        }, {
            ...
            value: function(t) {
                ...
                this.container.style.display = "", this.container.style.zIndex = "1", this.trigger("buildInStart"), t && "none" !== t.type && !this.banner.noAnimation && s > 1 ? (this.addClass(this.container, "buildin"), l = parseFloat(t.duration) || 0, a && (a.style.display = ""), "hide" !== t.crosstype ? Z.animate(i, t, "buildIn") : a && (a.style.zIndex = "2"), U((function() {
            ...
            value: function(t) {
                ...
                if (n && "none" !== n.type && e > 1) {
                    if (i.addClass(i.container, "buildout"), "show" !== n.crosstype) {
                        var o = m(n);
                        Z.animate(this.getAnimationEl(), o, "buildOut")
                    }
                    r = U((function() {
    ...
    var _t = function(t) {
        function e() {
            ...
            ! function(t, e) {
                ...
                return !e || "object" !== kt(e) && "function" != typeof e ? Et(t) : e
            }(this, xt(e).call(this)), j.init();
            var n = Et(t);
            return t.banner = new Ct, t.initBanner = function() {
    ...
    var Rt = function(t) {
        function e(t) {
            ...
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), (n = Mt(this, Ft(e).call(this))).retina = t, n
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
    ...
    var qt = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), Gt(this, Yt(e).apply(this, arguments))
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function(t) {
                var n, i;
                if (this.properties = t.properties, this.createMainContainers("element", "svg"), this.properties.resourceKey && this.slide.banner.displayData.resources) {
                    var r = this.slide.banner.displayData.resources[this.properties.resourceKey],
                        o = r && function(t, e) {
                            var n = document.createElementNS("http://www.w3.org/2000/svg", "svg");
                            n.innerHTML = t;
                            for (var i = n.querySelectorAll("[data-color-group]"), r = 0; r < i.length; r++) i[r] && i[r].dataset && i[r].setAttribute("fill", e[parseInt(i[r].dataset.colorGroup)]);
                            return n.innerHTML
                        }(r.content, this.properties.colorGroups);
                    (i = this.createElement("img", "svg-img", !1, null)).setAttribute("src", "data:image/svg+xml;charset=UTF-8,".concat(encodeURIComponent(o)))
                } else {
                    if (this.properties.localUrl) {
                        var a = void 0 !== bannerConfig.imgLocalPath ? bannerConfig.imgLocalPath : "media/";
                        n = "".concat(a).concat(this.properties.localUrl)
                    } else this.properties.url && (n = "".concat(bannerConfig.photosUrl).concat(this.properties.url));
                    var s = n + this.properties.id;
                    i = this.createElement("img", "svg-img", !1, null, window.assetsCache[s])
                }
                this.displayContainer.appendChild(i);
                var l = this.getFlipString(this.properties.flip);
                return this.transform("translateZ(0) rotate(".concat(this.properties.rotation, "deg) ").concat(l), this.displayContainer), this.applyFilters(this.displayContainer, this.properties.adjustColor, this.properties.blur, this.properties.dropShadow), this.reset(), this.slide.banner.statsPresent && this.slide.banner.stats.trackEvent(this.displayContainer, this), this.applyActions(this.createActionProperties(), this.displayContainer), Wt(Yt(e.prototype), "init", this).call(this, t)
            }
    ...
    function $t(t, e, n) {
        return ($t = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(t, e, n) {
            var i = function(t, e) {
    ...
    var te = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), Vt(this, Kt(e).apply(this, arguments))
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function(t) {
                var n = t.properties;
                return this.properties = n, this.createMainContainers("element", "text"), this.innerDisplayContainer = this.createElement("div", "innerDisplayContainer", !0, this.displayContainer, null), this.innerDisplayContainer.dir = n.textDirection || "ltr", this.initCommonProperties(), n.config ? this.initRichText() : this.initSimpleText(), this.reset(), $t(Kt(e.prototype), "init", this).call(this, t)
            }
        }, {
            ...
            value: function() {
                ...
                if (e.textAlign = t.alignment, e.lineHeight = t.lineHeight, e.letterSpacing = "".concat(t.letterSpacing, "px"), e.width = "100%", e.height = "100%", g(this.displayContainer, f(this.properties.textShadow)), this.applyFilters(this.displayContainer, !1, this.properties.blur), this.properties.scale) {
            ...
            value: function() {
                var t;
                $t(Kt(e.prototype), "reset", this).call(this, this), t = this.properties.config ? this.container.getElementsByClassName("word") : this.container.getElementsByClassName("text-content")[0].getElementsByTagName("span"), Z.clearWordsTimeout(this.container, t);
    ...
    var ae = function(t) {
            function e() {
                return function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, e), ie(this, re(e).apply(this, arguments))
            }
            var n, i, s;
            return function(t, e) {
                if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                ...
                value: function(t) {
                    ...
                    if (e["border-radius"] = e.border && e.border.radius ? e.border.radius : e.borderRadius, this.properties = e, this.createMainContainers("element", "bs-btn btn".concat(e.id)), e.localUrl && e.localUrl.includes(".svg")) {
                        ...
                        g(this.textContainer, e.labelStyle), g(this.textContainer, f(e.labelShadow)), n.weight && this.applyExtraPropertiesForGradients(this.displayContainer)
                    }
                    g(this.displayContainer, h(e.dropShadow)), this.displayContainer.style.border = this.getBorderString(), this.applyBackground(this.displayContainer, e.backgroundColor);
        ...
        ce = function(t, e) {
            ...
            switch (t.direction) {
                case "l2r":
                    n = 0, r = e ? "left center" : "right center";
                    break;
                case "r2l":
                    n = 0, r = e ? "right center" : "left center";
                    break;
                case "t2b":
                    i = 0, r = e ? "center top" : "center bottom";
                    break;
                case "b2t":
                    i = 0, r = e ? "center bottom" : "center top";
                    break;
                case "center":
                    n = 0, i = 0, r = "center center"
            }
            return {
                startScaleX: n,
                startScaleY: i,
        ...
        ue = function(t, e) {
            var n = "buildIn" === e,
                ...
                o = i.startScaleY,
                a = i.transformOrigin,
                s = "scale_".concat(e, "_").concat(a.replace(" ", "_"), "_").concat(r, "_").concat(o);
            if (_(s)) return s;
            var l = {
                transform: "scaleX(".concat(r, ") scaleY(").concat(o, ")"),
                "transform-origin": a
            };
            return T(s, [{
                percent: n ? 0 : 100,
        ...
        pe = function(t, e) {
            var n = "buildIn" === e,
                ...
                o = i.startScaleY,
                a = i.transformOrigin,
                s = "scaleElastic_".concat(e, "_").concat(a.replace(" ", "_"), "_").concat(r, "_").concat(o);
            if (_(s)) return s;
            for (var l, c = function(t) {
                    return r || t
                }, u = function(t) {
                    return o || t
                }, d = [
                    ...
                    [88, c(.99), u(.99)],
                    [100, 1, 1]
                ], p = [], f = 0; l = d[f]; f++) p.push({
                percent: n ? l[0] : 100 - l[0],
                props: {
                    transform: "scaleX(".concat(l[1], ") scaleY(").concat(l[2], ")"),
                    "transform-origin": a
                }
            });
            return T(s, p), s
        ...
        fe = function(t, e) {
            var n = "buildIn" === e,
                ...
                o = i.startScaleY,
                a = i.transformOrigin,
                s = "scaleBounce_".concat(e, "_").concat(a.replace(" ", "_"), "_").concat(r, "_").concat(o);
            if (_(s)) return s;
            for (var l, c = function(t) {
                    return r || t
                }, u = function(t) {
                ...
                var h = {
                    transform: "scaleX(".concat(l[1], ") scaleY(").concat(l[2], ")"),
                    "transform-origin": a,
                    "animation-timing-function": f % 2 ? "ease-out" : "ease-in"
                };
                p.push({
                    percent: n ? l[0] : 100 - l[0],
                    props: h
        ...
        he = function(t, e) {
            var n = "buildIn" === e,
                i = "blur_".concat(e, "_").concat(t.blurAmount);
            if (_(i)) return i;
            var r = {
                filter: "blur(".concat(t.blurAmount, "px)"),
                opacity: "0"
    ...
    window.BS_eaUtils = r, window.BS_eaUtils, window.BS_eff = Z, window.BS_eff, window.BS_EventDispatcher = et, window.BS_EventDispatcher, window.BS_BaseDisplay = ct, window.BS_BaseDisplay, window.BS_BannerDisplay = Ct, window.BS_BannerDisplay, window.BS_SlideDisplay = bt, window.BS_SlideDisplay, window.BS_EmbedCanvas = _t, window.BS_EmbedCanvas, window.BS_ImageDisplay = Dt, window.BS_ImageDisplay, window.BS_ShapeDisplay = Rt, window.BS_ShapeDisplay, window.BS_SvgDisplay = qt, window.BS_SvgDisplay, window.BS_TextDisplay = te, window.BS_TextDisplay, window.BS_ButtonDisplay = ae, window.BS_ButtonDisplay, window.BS_roll = le, window.BS_roll, window.BS_scale = ue, window.BS_scale, window.BS_slide = de, window.BS_slide, window.BS_scaleElastic = pe, window.BS_scaleElastic, window.BS_scaleBounce = fe, window.BS_scaleBounce, window.BS_blur = he, window.BS_blur, window.BS_init = ye, window.BS_init, window.BS_ShowWatermark = function() {
