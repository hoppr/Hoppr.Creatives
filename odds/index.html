...
<html lang="en">
   ...
   <body>
      ...
      <div id="bookmakers-container" style="margin-top: 50px;">
      </div>
      <div id="spacer">
      </div>
      ...
      <script>
         ...
         function onMessageReceived2(message) {
            ...
            async function fetchApiData(sports,oddsFormat,title) {
               ...
               const url = `https://api.the-odds-api.com/v4/sports/${sports}/odds/?apiKey=3a4a96544f6463e3f72df335653064ac&regions=us&markets=spreads,totals,h2h&oddsFormat=${oddsFormat}`;
