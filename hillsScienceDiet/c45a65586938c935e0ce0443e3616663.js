! function(t) {
    ...
    var x = function(t) {
        ...
        A = function(t, e) {
            if (!T[t]) {
                ...
                l.type = "text/css", l.styleSheet ? l.styleSheet.cssText = s : l.innerHTML = s, document.getElementsByTagName("head")[0].appendChild(l), T[t] = !0
            }
        },
        P = function(t, e) {
    ...
    var j = function() {
        ...
        }], (n = null) && B(e.prototype, n), i && B(e, i), t
    }();
    D(j, "timers", {}), D(j, "animations", {}), D(j, "timerIndex", 0);
    var U = function(t, e) {
            var n = j.timerIndex++;
            return j.timers[n] = new L(t, e), n
        },
        M = function(t) {
            var e = j.timers[t];
    ...
    var Dt = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), It(this, Lt(e).apply(this, arguments))
        }
        var n, i, s;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
    ...
    var Rt = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), Mt(this, zt(e).apply(this, arguments))
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function(t) {
                var n = t.properties;
                return this.properties = n, this.createMainContainers("element", "text"), this.innerDisplayContainer = this.createElement("div", "innerDisplayContainer", !0, this.displayContainer, null), this.innerDisplayContainer.dir = n.textDirection || "ltr", this.initCommonProperties(), n.config ? this.initRichText() : this.initSimpleText(), this.reset(), Ft(zt(e.prototype), "init", this).call(this, t)
            }
        }, {
            ...
            value: function() {
                var t;
                Ft(zt(e.prototype), "reset", this).call(this, this), t = this.properties.config ? this.container.getElementsByClassName("word") : this.container.getElementsByClassName("text-content")[0].getElementsByTagName("span"), Z.clearWordsTimeout(this.container, t);
    ...
    var Jt = function(t) {
        function e() {
            return function(t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), Gt(this, Xt(e).apply(this, arguments))
        }
        var n, i, r;
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function(t) {
                ...
                return this.transform("translateZ(0) rotate(".concat(this.properties.rotation, "deg) ").concat(l), this.displayContainer), this.applyFilters(this.displayContainer, this.properties.adjustColor, this.properties.blur, this.properties.dropShadow), this.reset(), this.slide.banner.statsPresent && this.slide.banner.stats.trackEvent(this.displayContainer, this), this.applyActions(this.createActionProperties(), this.displayContainer), Yt(Xt(e.prototype), "init", this).call(this, t)
            }
        }]) && Wt(n.prototype, i), r && Wt(n, r), e
    }(ct);
    ...
    var te = function(t) {
            function e(t) {
                ...
                return function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, e), (n = $t(this, Kt(e).call(this))).retina = t, n
            }
            var n, i, r;
            return function(t, e) {
                if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
    ...
    window.BS_eaUtils = r, window.BS_eaUtils, window.BS_eff = Z, window.BS_eff, window.BS_EventDispatcher = et, window.BS_EventDispatcher, window.BS_BaseDisplay = ct, window.BS_BaseDisplay, window.BS_BannerDisplay = kt, window.BS_BannerDisplay, window.BS_SlideDisplay = bt, window.BS_SlideDisplay, window.BS_EmbedCanvas = _t, window.BS_EmbedCanvas, window.BS_ButtonDisplay = Dt, window.BS_ButtonDisplay, window.BS_TextDisplay = Rt, window.BS_TextDisplay, window.BS_SvgDisplay = Jt, window.BS_SvgDisplay, window.BS_ImageDisplay = te, window.BS_ImageDisplay, window.BS_alpha = ee, window.BS_alpha, window.BS_scale = ie, window.BS_scale, window.BS_rotate = re, window.BS_rotate, window.BS_slide = ae, window.BS_slide, window.BS_init = se, window.BS_init, window.BS_ShowWatermark = function() {
