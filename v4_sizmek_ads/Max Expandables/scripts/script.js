...
function addEventListeners() {
  ...
  show_toast_btn.addEventListener("click", () =>
    sendHopprToast("ShowWebViewToast", "This text come from the WebView")
  );
  // show_toast_btn_2.addEventListener("click", () =>
  //   sendHopprToast("ShowWebViewToast", "Toast One")
  // );
  ...
  deeplink_netflix_btn.addEventListener("click", () =>
    sendIntent("Intent", "http://www.netflix.com/watch/70202141")
  );
  user_properties_btn.addEventListener("click", () =>
    requestHopprUserProperties()
  );

  gravity_bottom_left_btn.addEventListener("click", () =>
    setHopprWebviewGravity(AndroidGravity.BOTTOM_LEFT)
  );
  gravity_top_right_btn.addEventListener("click", () =>
    setHopprWebviewGravity(AndroidGravity.TOP_RIGHT)
  );
  gravity_bottom_right_btn.addEventListener("click", () =>
    setHopprWebviewGravity(AndroidGravity.BOTTOM_RIGHT)
  );
  gravity_center_btn.addEventListener("click", () =>
    setHopprWebviewGravity(AndroidGravity.CENTER)
  );
  ...
  if (obj?.source === "Hoppr") {
    ...
    switch (obj.type) {
      ...
      case "keyEvent":
        ...
        break;
      case "userData":
        document.getElementById("userProperties").innerText =
          "User Properties: " + JSON.stringify(obj?.data);
        break;
      default:
        break;
    }
